...
from int_crossover import single_point_crossover_pygad,two_point_crossover_pygad,uniform_crossover_pygad,make_uniform_crossover_pygad
...
func = get_function("Hypersphere", num_genes)
num_generations = 100
sol_per_pop = 80
...
def decodeInd(individual):
    ...
    #bounds = [(init_range_low, init_range_high)] * num_vars
...
custom_crossover = make_uniform_crossover_pygad(0.7)
ga_instance = pygad.GA(
            ...
            crossover_type=custom_crossover,#ga_instance = pygad.GA(..., crossover_type=single_point_crossover_pygad, ...)
